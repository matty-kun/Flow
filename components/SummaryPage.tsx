      ...
      >
        ...
        <View style={{ flexDirection: "row", paddingHorizontal: 24, marginBottom: 20 }}>
          ...
          <View style={{ flex: 1 }}>
            ...
            <Text style={{ fontSize: 22, fontWeight: "900", color: TEXT }} numberOfLines={1}>{topCategory ? topCategory.label : "None yet"}</Text>
          </View>
          <View style={{ flex: 1 }}>
            ...
            <Text style={{ fontSize: 22, fontWeight: "900", color: TEXT }} numberOfLines={1}>{longestSession ? formatDuration(Math.round((longestSession.duration || 0) / 60)) : "All clear"}</Text>
          </View>
        </View>
